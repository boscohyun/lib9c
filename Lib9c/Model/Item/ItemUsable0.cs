...
namespace Nekoyume.Model.Item
{
    ...
    [Serializable]
    public abstract class ItemUsable0 : ItemBase, INonFungibleItem
    {
        ...
        protected ItemUsable0(ItemSheet.Row data, Guid id, long requiredBlockIndex) : base(data)
        {
            ItemId = id;
        ...
        protected ItemUsable0(Dictionary serialized) : base(serialized)
        {
            StatsMap = new StatsMap();
            Skills = new List<Model.Skill.Skill>();
            BuffSkills = new List<BuffSkill>();
        ...
        protected ItemUsable0(SerializationInfo info, StreamingContext _)
            : this((Dictionary) Codec.Decode((byte[]) info.GetValue("serialized", typeof(byte[]))))
        {
        }

        protected bool Equals(ItemUsable0 other)
        {
